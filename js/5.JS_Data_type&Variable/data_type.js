...
/* 
    ...
    - '==' 은 값만 같음을 표기 (데이터 타입은 판별 안함, 타입까지 판별 하려면 '===')
*/
...
/*
    - javascript의 문자열은 배열처럼 인덱스르르 이용해서 접근 할 수 있음 (유사 배열)
*/
for (var index = 0; index < name_.length; index++) //{console.log(name_[index])}
