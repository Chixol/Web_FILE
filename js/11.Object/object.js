...
const goJong = { // 키와 변수명이 같다면 앞에 키를 지울 수 있음
    name,
    age,
    address
}
...
/*
    속성 이름 (속성 키) : 
    - 일반적으로 문자열로 표기함
    - 자바스크립트에서 사용 유효한 이름 (변수 이름으로 사용가능한 이름) 일 경우에는 따옴표를 생략할 수 있음
...
*/
console.log(parkHyungwoo.age);
console.log(parkHyungwoo["last-name"]);
let property = 'first name';
console.log(parkHyungwoo[property]);
...
// name, age, address 
sunJong = {...goJong}; //{}안에 표현하면 새로운 공간에 키를 복사하여 새로운 주소를 갖게됨
console.log(sunJong);
