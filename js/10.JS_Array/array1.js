...
*/
const emptyArray = []; //길이가 0인 요소(빈 배열)
...
// console.log(emptyArray2[]); // 2번 배열에 10, 앞쪽엔 empty item
console.log(emptyArray2[0]); // 0번 배열은 undefined로 출력
...
/*
    - for-in 순회 방식은 index를 사용하여 한 번 더 작업해야 하기 때문에 요소를 읽어들이는 순회에는 접합하지 않을 수 있음
    - forEach 메서드 혹은 for - of 문을 사용
*/
for (const item of fruits) { // 읽기 전용에 적합
    console.log(item);
}
